...
| **v2.5 — the final G-Forge release** *(current)* | M47 Planning-Pipeline Honesty → M48 Review-Pipeline Hardening → M51 Release Reliability (M45-lite, absorbing M45; added 2026-08-20) → M50 Eval-Chain Integrity (folded in 2026-08-17) → M38 G-Report → M40 Reference Convention → M43 Operator Controls → M49 Devil's-Advocate Agent (folded in 2026-08-14) → M41 Release Machinery (cuts the release, last) | The freeze release ships everything the approved announcement promises (ADR-012, amended 2026-08-14: +M49; amended 2026-08-17: +M50; amended 2026-08-20: +M51, folds M45) |
