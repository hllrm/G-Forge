...
Active context:   · v2.0.0 on branch claude/m23-release-u3rx0d. Name kept as G-Forge. Hooks: single registrar (.claude/settings.json via /g-init), manifest registers none, all 7 self-guard on .claude/integration-tier. G-Forge's docs namespace is now g-docs/ (plans, decisions, retros, agent-output, forecasts, …) so it never mixes with a project's docs/. Counts: 17 agents · 35 skills · 36 commands (35 skill-backed + /g-forge router; the deprecated /g-team alias was removed in 2.0) · 56 profiles (48 stack + 7 combo + 1 supplementary).
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
```
